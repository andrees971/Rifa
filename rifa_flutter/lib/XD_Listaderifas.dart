...
class XD_Listaderifas extends StatelessWidget {
  XD_Listaderifas({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Informacion de la rifa'),
      ),
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(15.0, 575.5, 375.0, 49.0),
                    size: Size(412.0, 806.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(15.0, 151.0, 260.0, 35.0),
                    size: Size(412.0, 806.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(300.0, 716.0, 86.0, 90.0),
                    size: Size(412.0, 806.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(21.0, 0.0, 44.0, 84.0),
                          size: Size(86.0, 90.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
...
const String _svg_7gx4u6 =
    '<svg viewBox="16.0 624.5 375.0 1.0" ><path transform="translate(16.0, 624.5)" d="M 0 0 L 375 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
